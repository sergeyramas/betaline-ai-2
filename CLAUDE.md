...
- **ГЛОБАЛЬНАЯ правка** — меняет логику или устройство сайта, а не только внешний вид.
  Маршрут другой: агент НЕ идёт к Андрею сразу. План оформляется как **Вопрос владельцу
  (Сергею)** через механизм «Вопросы» в RamOS. Сергей либо подписывает план как есть, либо
  правит формулировку. Только утверждённый Сергеем вариант уходит Андрею на согласование,
