...
- **ГЛОБАЛЬНАЯ правка** — меняет логику или устройство сайта, а не только внешний вид.
  ...
  **Ревью Codex — правила.** Read-only: ревьюер разбирает риски, не правит код и
  ...
  можно, читать чужой чат — нет, это привилегия диспетчера). На практике вердикт
  ревьюера может дойти только письмом обратно в ЭТОТ чат — отдельным, новым заданием,
  не продолжением текущего разговора. Если в разумный срок такое письмо не пришло (или
