...
| Яндекс.Директ | агентский аккаунт `gowindo.elama1` (eLama), клиентский логин `ulogin=e-16571744`. Образец — кампания `708929168` (betaline-ai.ru, остановлена). **Мастер кампаний на custom2 — `714447865`, черновик с 15.09**: Россия, макс. целевых действий, средняя CPA (фикс. недоступна — у нового счётчика нет истории), бюджет 10 000 ₽/нед, 4 цели счётчика 112650916 (доступ «Просмотр» выдан e-16571744), креативы `assets/img/ads/*-text.jpg` (`tools/ad-creatives.py`). Запуск/оплата — только оператор |
